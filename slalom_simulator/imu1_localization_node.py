#!/usr/bin/env python3
"""
IMU1 Localization Node - Dead reckoning using IMU1 data.
Integrates IMU1 accelerations to estimate vehicle position.
"""
import rclpy
...
class IMU1LocalizationNode(Node):
    def __init__(self):
        super().__init__('imu1_localization_node')
        ...
        # Publisher
        self.pose_pub = self.create_publisher(PoseStamped, '/imu1/pose', 10)

        # Subscriber
        self.imu_sub = self.create_subscription(
            Imu, '/imu1/data', self.imu_callback, 10)

        self.get_logger().info('IMU1 Localization node initialized')

    def imu_callback(self, msg):
        """Process IMU1 data and integrate to estimate position"""
